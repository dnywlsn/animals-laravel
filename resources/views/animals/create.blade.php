...
@section('title', __('Add New Friend'))

@section('content')
<div class="form-wrapper">
    <div class="glass-card form-card">
        <div class="form-header">
            <h2>{{ __('Add New Friend') }}</h2>
            <p>{{ __('Enter the details of the animal to find them a new home.') }}</p>
        </div>
        ...
        <form action="{{ route('animals.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="species" class="form-control" list="speciesList" placeholder="{{ __('Select or type...') }}" required>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control" required>
                        ...
                        <option value="adopted">{{ __('Adopted') }}</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="4" placeholder="{{ __('Tell us more about this friend...') }}" required></textarea>
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary">{{ __('Save Animal') }}</button>
            </div>
        </form>
    </div>
</div>
