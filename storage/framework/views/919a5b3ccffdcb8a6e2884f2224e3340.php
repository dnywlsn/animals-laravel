<?php $__env->startSection('title', __('Edit Friend')); ?>

<?php $__env->startSection('content'); ?>
<div class="form-wrapper">
    <div class="glass-card form-card">
        <div class="form-header">
            <h2><?php echo e(__('Edit Details')); ?>: <?php echo e($animal->name); ?></h2>
            <p><?php echo e(__('Update the information for this animal.')); ?></p>
        </div>
        ...
        <form action="<?php echo e(route('animals.update', $animal)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="<?php echo e($animal->name); ?>" required>
                </div>

                <div class="form-group">
                    <label><?php echo e(__('Species / Category')); ?></label>
                    <input type="text" name="species" class="form-control" list="speciesList" value="<?php echo e($animal->species); ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="age" class="form-control" value="<?php echo e($animal->age); ?>" required>
                </div>

                <div class="form-group">
                    <label><?php echo e(__('Status')); ?></label>
                    <select name="status" class="form-control" required>
                        <option value="available" <?php echo e($animal->status == 'available' ? 'selected' : ''); ?>><?php echo e(__('Available')); ?></option>
                        <option value="pending" <?php echo e($animal->status == 'pending' ? 'selected' : ''); ?>><?php echo e(__('Pending')); ?></option>
                        <option value="adopted" <?php echo e($animal->status == 'adopted' ? 'selected' : ''); ?>><?php echo e(__('Adopted')); ?></option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="4" required><?php echo e($animal->description); ?></textarea>
            </div>

            <div class="form-group">
                <label><?php echo e(__('Update Image')); ?></label>
                <div class="image-upload-wrapper">
                    <input type="file" name="image" id="imageInput" class="form-control" accept="image/*">
                    <div id="imagePreview" class="image-preview">
                        <?php if($animal->image_path): ?>
                            <img src="<?php echo e(asset('storage/' . $animal->image_path)); ?>" style="width:100%; height:100%; object-fit:cover; border-radius:12px;">
                        <?php else: ?>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary"><?php echo e(__('Update Animal')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/oralbek/Desktop/aizhan-project/resources/views/animals/edit.blade.php ENDPATH**/ ?>