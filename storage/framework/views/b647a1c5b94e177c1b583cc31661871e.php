...
<div class="dashboard-page">
    <div class="page-header glass-card">
        <div class="header-text">
            ...
            <p><?php echo e(__('Real-time overview of shelter activity and community impact.')); ?></p>
        </div>
        <div class="header-actions">
            <button class="btn btn-primary btn-sm">⚡ <?php echo e(__('Export Report')); ?></button>
        </div>
    </div>
    ...
    <div class="stats-grid">
        <div class="glass-card stat-item">
            ...
            <div class="stat-content">
                <span class="stat-label"><?php echo e(__('Total Animals')); ?></span>
                <span class="stat-value"><?php echo e($stats['total']); ?></span>
                <span class="stat-trend positive">↑ 12% <?php echo e(__('this month')); ?></span>
            </div>
        </div>
        <div class="glass-card stat-item">
            <div class="stat-icon" style="color: #2ecc71;">✅</div>
            <div class="stat-content">
                <span class="stat-label"><?php echo e(__('Available')); ?></span>
                <span class="stat-value"><?php echo e($stats['available']); ?></span>
                <span class="stat-trend"><?php echo e(__('Ready for home')); ?></span>
            </div>
        </div>
        <div class="glass-card stat-item">
            <div class="stat-icon" style="color: #f1c40f;">⏳</div>
            <div class="stat-content">
                <span class="stat-label"><?php echo e(__('Pending')); ?></span>
                <span class="stat-value"><?php echo e($stats['pending']); ?></span>
                <span class="stat-trend"><?php echo e(__('In interview')); ?></span>
            </div>
        </div>
        <div class="glass-card stat-item">
            <div class="stat-icon" style="color: #e74c3c;">🏠</div>
            <div class="stat-content">
                <span class="stat-label"><?php echo e(__('Adopted')); ?></span>
                <span class="stat-value"><?php echo e($stats['adopted']); ?></span>
                <span class="stat-trend positive">↑ 8 <?php echo e(__('new families')); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="charts-grid">
        <div class="glass-card chart-item">
            <div class="chart-header">
                <h3><?php echo e(__('Shelter Growth & Trends')); ?></h3>
                <span class="chart-period"><?php echo e(__('Last 6 Months')); ?></span>
            </div>
        ...
        <div class="glass-card chart-item">
            <h3><?php echo e(__('Community Interaction')); ?></h3>
            <div class="activity-list">
                <div class="activity-item">
                    <div class="act-icon">💬</div>
                    <div class="act-text">
                        <strong><?php echo e(__('New Inquiry')); ?></strong>
                        <p><?php echo e(__('Someone is interested in Barbos')); ?></p>
                        <span>2 <?php echo e(__('hours ago')); ?></span>
                    </div>
                </div>
                <div class="activity-item">
                    <div class="act-icon">🎉</div>
                    <div class="act-text">
                        <strong><?php echo e(__('Success!')); ?></strong>
                        <p><?php echo e(__('Murka has been adopted')); ?></p>
                        <span>5 <?php echo e(__('hours ago')); ?></span>
                    </div>
                </div>
                <div class="activity-item">
                    <div class="act-icon">👤</div>
                    <div class="act-text">
                        <strong><?php echo e(__('New Volunteer')); ?></strong>
                        <p><?php echo e(__('Arman joined the team')); ?></p>
                        <span>1 <?php echo e(__('day ago')); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bottom-grid">
        <div class="glass-card info-item">
            <h3><?php echo e(__('Species Distribution')); ?></h3>
            <div class="chart-wrapper-small">
                <canvas id="speciesChart"></canvas>
            </div>
        </div>
        <div class="glass-card info-item">
            <h3><?php echo e(__('Quick Notes')); ?></h3>
            <ul class="notes-list">
                <li>📌 <?php echo e(__('Check vaccination for new puppy')); ?></li>
                <li>📌 <?php echo e(__('Update social media with adoption stories')); ?></li>
                <li>📌 <?php echo e(__('Restock animal food by Friday')); ?></li>
                <li>📌 <?php echo e(__('Interview 3 potential adopters')); ?></li>
            </ul>
        </div>
    </div>
</div>
...
<script>
    ...
    new Chart(document.getElementById('speciesChart'), {
        type: 'doughnut',
        data: {
            labels: ["<?php echo e(__('Dogs')); ?>", "<?php echo e(__('Cats')); ?>", "<?php echo e(__('Others')); ?>"],
            datasets: [{
                data: [<?php echo e($speciesData['Dogs']); ?>, <?php echo e($speciesData['Cats']); ?>, <?php echo e($speciesData['Others']); ?>],
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/aizhan/Downloads/aizhan-project/resources/views/dashboard.blade.php ENDPATH**/ ?>